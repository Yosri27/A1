...
import { ApplicationExceptions, BadRequestException, NotFoundException,ConflictException } from "../../common/exceptions/application.exceptions.js";
...
async signupGmail(token:{idToken:string})
    {
